...
| ![Thirteen](../../../assets/platform/NumberLabels/Thirteen.png) | Settings | Click to change base map layers, map projection, and units |
| ![Fourteen](../../../assets/platform/NumberLabels/Fourteen.png) | Ruler | Click to draw a line and measure the distance between 2 points |
| ![Fifteen](../../../assets/platform/NumberLabels/Fifteen.png) | Help Center | Click to report an issue, contact us, or access the documentation |
...
![EarthPlatform Polygon Area Calculator](../../../assets/platform/CatalogUI/AreaCalculator.png)

![EarthPlatform Rectangular Area Calculator](../../../assets/platform/CatalogUI/AreaCalculatorSqr.png)
...
| S. No | Label | Description |
|-------|-------|-------------|
| ![ThirtyOne](../../../assets/platform/NumberLabels/ThirtyOne.png) | Image Opacity | Toggle the opacity/transparency of an image |
| ![ThirtyTwo](../../../assets/platform/NumberLabels/ThirtyTwo.png) | Image Footprint Opacity | Toggle the opacity/transparency of the footprint |
