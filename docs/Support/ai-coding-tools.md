...
-   :material-file-document-outline: **llms.txt**
    ...
    <button class="md-button md-button--secondary" onclick="navigator.clipboard.writeText('https://earthdaily.github.io/earthdaily-documentation/llms.txt').then(function(){var b=this;b.textContent='Copied!';setTimeout(function(){b.textContent='Copy link'},2000)}.bind(this))">Copy URL</button> 
