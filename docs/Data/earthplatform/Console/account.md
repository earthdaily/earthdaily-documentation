...
| ![Three](../../../assets/data/NumberLabels/Three.png) | API Credentials | Token URL to generate "Bearer Token" for API authentication. [Details of How to Provision](../GettingStarted/authentication.md) |
