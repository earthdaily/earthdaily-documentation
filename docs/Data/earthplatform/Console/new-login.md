...
Your new API token can be used with existing scripts and tools that use the **OAuth Client Credentials Flow** as described in the [Authentication Page](../GettingStarted/authentication.md). Simply use these values in place of your old credential information:
