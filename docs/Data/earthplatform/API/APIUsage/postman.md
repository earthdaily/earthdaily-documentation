...
Before you try out the various endpoints, you need to set up the authentication for Postman. [Authentication Page](../../GettingStarted/authentication.md#postman) describes how it is done.
