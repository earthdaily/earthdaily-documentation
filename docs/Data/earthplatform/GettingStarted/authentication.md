...
description: How to authenticate with the EarthDaily STAC API using OAuth client credentials
keywords:
  - API authentication
  - OAuth
  - client credentials
...
- [Authentication](#authentication)
    - [Provision New API Credentials](#provision-new-api-credentials)
    - [Provision Legacy API Credentials](#provision-legacy-api-credentials)
...
![Client Credentials](../../../assets/data/STACAPI/NewLogin%20NoAPI%20Creds%20Provisioned.png)
...
![New API Credentials](../../../assets/data/STACAPI/New%20API%20Creds.png)
...
![Delete and Download Creds](../../../assets/data/STACAPI/New%20API%20Creds%20on%20Accounts%20Page.png)

### Provision Legacy API Credentials
...
![Legacy API Credentials](../../../assets/data/STACAPI/Legacy%20API%20Creds%20on%20Accounts%20Page.png)
...
- `EDS_AUTH_URL` refers to the **Access token URL** shown on the Accounts page
...
![Postman](../../../assets/data/STACAPI/PostmanConfiguration.png)
