...
|:-----------------------------:|:-----------------------:|:------------------------------:|
| ![ESA Cloud Mask](../../assets/data/ProductImages/ESA_Cloud_Mask.png) | ![RGB Data](../../assets/data/ProductImages/RGB_Cloud_Mask.png) | ![EDA Cloud Mask](../../assets/data/ProductImages/EDA_Cloud_Mask.png) |
...
|:----------------------------------------:|:----------------------------------:|
| ![Cloud Halos](../../assets/data/ProductImages/CloudHalos.png) | ![Pixel Selection](../../assets/data/ProductImages/PixelSelection.png) |
