---
title: Iris Header Bar
description: Overview of the Iris header bar tools including bookmarks, basemaps, zoom controls, pixel inspector, changelog, and help links.
keywords:
  - Iris header
  - bookmarks
  - basemaps
