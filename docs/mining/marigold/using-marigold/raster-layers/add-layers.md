---
title: Add Raster Layers
description: "Add raster layers to a Marigold project from the EarthOne Catalog or by importing exported layers from other projects."
keywords:
  - add raster layers
  - catalog layers
  - imported layers
...
![image](images/add-catalog-searched.png)

Click on a name to display information about that layers.

![image](images/add-catalog-select-name.png)
...
![image](images/add-catalog-multiselect.png)
