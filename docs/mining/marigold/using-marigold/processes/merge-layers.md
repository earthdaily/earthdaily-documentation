---
title: Merge Layers
description: "Combine bands from multiple raster layers into a single product in Marigold using the Merge Layers tool for unified visualization and analysis."
keywords:
  - merge layers
  - combine bands
  - multiband
