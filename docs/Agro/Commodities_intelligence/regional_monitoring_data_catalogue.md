...
![Link between providers, time of delivery and reprocessing of the data](images/regional-monitoring/weather-data-providers.jpg)
*Figure 1 - Link between providers, time of delivery and reprocessing of the data*

## Parameters, related maps and graphs

![Different data parameters and corresponding maps and curves](images/regional-monitoring/parameters-maps-graphs.jpg)
*Figure 2 - Different data parameters and corresponding maps and curves*

## Data technical description

![List of data types and their units (1)](images/regional-monitoring/data-types-units-1.jpg)
*Figure 3 - List of data types and their units (1)*

![List of data types and their units (2)](images/regional-monitoring/data-types-units-2.jpg)
*Figure 4 - List of data types and their units (2)*

## Available levels of aggregation

![Available regions and level of aggregation](images/regional-monitoring/regions-aggregation-levels.jpg)
...
- Via the help desk at [https://geosys-cfe.atlassian.net/servicedesk/customer/portal/45](https://geosys-cfe.atlassian.net/servicedesk/customer/portal/45)
- By email at [https://earthdailyagro.com/contact](https://earthdailyagro.com/contact/)
- Or through our local team
